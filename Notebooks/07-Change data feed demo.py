...
#adls_stg_path = f"{base_path}/{username}/people10m_stg"
#adls_path = f"{base_path}/{username}/people10m_table"
...
# MAGIC %sql
# MAGIC Insert into silverTable Values ("Australia", 100, 3000)
...
# MAGIC %sql
# MAGIC -- I want to select * from the temp view i created
